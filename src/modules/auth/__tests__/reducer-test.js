 ...
 * as well
 */
const  authReducer = require('../reducers').default
/**
 * ## Tests
 * 
 * authReducer
...
describe('authReducer', () => {
  ...
  describe('STATE_LOGOUT', () => {
    ...
    it('form is valid to logout', () => {
      ...
      expect(next.form.state).toBe(STATE_LOGOUT)
  ...
  describe('STATE_FORGOT_PASSWORD', () => {
    ...
    it('form is not valid with empty field', () => {
      ...
      expect(next.form.state).toBe(STATE_FORGOT_PASSWORD)
  ...
  describe('STATE_LOGIN', () => {
    ...
    it('form is not valid with empty fields', () => {
      ...
      expect(next.form.state).toBe(STATE_LOGIN)
      expect(next.form.isValid).toBe(false)
    })
    /**
  ...
  describe('STATE_REGISTER', () => {
    ...
    it('form is not valid with empty fields', () => {
      ...
      expect(next.form.state).toBe(STATE_REGISTER)
      expect(next.form.isValid).toBe(false)
    })
    /**
     * #### form is  valid with valid fields
